    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative pt-[120px] min-h-[380px] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img src={`${import.meta.env.BASE_URL}images/news_dispensing.webp`} alt="Dược lâm sàng" className="w-full h-full object-cover" />
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <img src={`${import.meta.env.BASE_URL}images/news_training.webp`} alt="Tài liệu dược lâm sàng" className="w-full object-cover" />
            </div>
          </div>
        </div>
      </section>

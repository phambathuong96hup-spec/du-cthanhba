...
const allNews = [
  { id: 1, title: 'Hội nghị tập huấn sử dụng thuốc an toàn, hợp lý năm 2024', date: '15 tháng 3, 2024', category: 'Tập huấn & Đào tạo', summary: 'Khoa Dược tổ chức buổi tập huấn cho đội ngũ y bác sĩ về các quy định mới trong kê đơn và sử dụng thuốc an toàn theo hướng dẫn của Bộ Y tế.', image: '/images/news_training.png',
    content: `
...
Khoa Dược sẽ tiếp tục tổ chức các buổi tập huấn chuyên sâu theo từng chuyên khoa trong những tháng tiếp theo.
  ...
  { id: 2, title: 'Triển khai quy trình cấp phát thuốc nội trú mới', date: '10 tháng 3, 2024', category: 'Hoạt động khoa', summary: 'Nhằm nâng cao hiệu quả và giảm thời gian chờ đợi, Khoa Dược áp dụng quy trình số hóa trong cấp phát thuốc nội trú.', image: '/images/news_dispensing.png',
    content: `
...
Người bệnh nội trú sẽ nhận thuốc đúng giờ hơn, giảm thiểu nguy cơ sai sót trong cấp phát và đảm bảo dây chuyền lạnh cho thuốc cần bảo quản đặc biệt.
  ...
  { id: 3, title: 'Đoàn kiểm tra Sở Y tế đánh giá cao công tác bảo quản thuốc', date: '5 tháng 3, 2024', category: 'Hoạt động khoa', summary: 'Hệ thống kho thuốc đạt chuẩn GSP của TTYT Thanh Ba được đánh giá là một trong những đơn vị dẫn đầu khu vực Phú Thọ.', image: '/images/news_inspection.png',
    content: `
...
TTYT Thanh Ba được xếp hạng top 3 đơn vị dẫn đầu toàn tỉnh Phú Thọ về công tác bảo quản dược phẩm chuẩn GSP năm 2024.
  ...
  { id: 4, title: 'Cập nhật Dược thư Quốc gia phiên bản mới nhất 2024', date: '28 tháng 2, 2024', category: 'Chuyên môn nghiệp vụ', summary: 'Khoa Dược đã cập nhật và phổ biến nội dung chính của Dược thư Quốc gia phiên bản 2024 đến toàn thể cán bộ.', image: '/images/news_training.png',
    content: `
...
Khoa Dược đã cập nhật toàn bộ cơ sở dữ liệu tra cứu thuốc nội bộ theo Dược thư mới và phân phối tài liệu tóm tắt đến từng khoa phòng lâm sàng.
  ...
  { id: 5, title: 'Ký kết hợp đồng cung ứng thuốc đấu thầu năm 2024', date: '20 tháng 2, 2024', category: 'Văn bản pháp luật', summary: 'TTYT Thanh Ba hoàn thành đấu thầu thuốc năm 2024 với danh mục thuốc đầy đủ 500+ hoạt chất đảm bảo cho công tác khám chữa bệnh.', image: '/images/banner_warehouse.png',
    content: `
...
Tất cả thuốc trúng thầu đều đạt tiêu chuẩn chất lượng theo quy định, có đầy đủ hồ sơ đăng ký lưu hành và được kiểm tra bởi cơ quan quản lý.
  ...
  { id: 6, title: 'Tập huấn quy trình báo cáo phản ứng có hại (ADR)', date: '15 tháng 2, 2024', category: 'Tập huấn & Đào tạo', summary: 'Toàn thể cán bộ y tế được tập huấn về nhận diện, xử trí và báo cáo phản ứng có hại của thuốc theo quy định mới.', image: '/images/news_training.png',
    content: `
...
Sau 1 tháng triển khai, tỷ lệ sử dụng kháng sinh phổ rộng giảm 12% so với cùng kỳ năm trước. Đây là tín hiệu tích cực cho thấy hiệu quả của chương trình.
  ...
  { id: 8, title: 'Kiểm kê thuốc và vật tư y tế quý I/2024', date: '1 tháng 2, 2024', category: 'Hoạt động khoa', summary: 'Khoa Dược hoàn thành kiểm kê toàn bộ kho thuốc quý I/2024. Tổng giá trị tồn kho đảm bảo cung ứng đủ cho 3 tháng hoạt động.', image: '/images/banner_warehouse.png',
    content: `
